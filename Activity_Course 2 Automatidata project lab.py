...
# ==> I will import the data into the python environment and using describe command check the type of data used in this and it is currently matched or not or is there any null values are inside or not. I will try to map null values to some relatable values.
